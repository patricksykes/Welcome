...
There are a range of variables available from the GCM outputs. In the file linked here (https://github.com/MathMarEcol/Welcome/files/CMIP6_MIP_tables.xlsx) upi can explore the available variables. Each tab has different model variables on different time scales. The tabs are in alphabetical order. 
