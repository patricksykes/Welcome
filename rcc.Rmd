...
The technical justification for Flashlight is:
...
> MathMarEcol Bioregionalisation on Flashlight
>
> My lab is working on large scale marine ecology and climate models. The input data is around 30-50TB. David Abramson has asked us to use Flashlight to demostrate the BeeGFS filesystem caching enhancements, which is only available on Flashlight.
